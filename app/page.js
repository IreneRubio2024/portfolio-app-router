...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#F5FBF9] text-[#171717] font-body">
      ...
      >
        <div className={`mx-auto flex max-w-6xl flex-col justify-between gap-8 rounded-3xl border p-6 shadow-sm md:flex-row md:items-center md:p-8 md:gap-0 ${darkHero ? "border-white/10 bg-white/5" : "border-white/10 bg-[#191E1E] text-[#FFFEF6]"}`}>
          <div>
            <p className="font-body text-sm uppercase tracking-[0.28em] text-white/45">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              <a href="https://github.com/IreneRubio2024" target="_blank" rel="noreferrer">
